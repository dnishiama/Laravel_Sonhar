...
<body>
<center><h1>Cadastro de Atividades</h1>
    <br>
...
<form action="{{ route('atividades.store') }}" method="post" role="form">
    {{ csrf_field() }}
    <div>
        <label for="ATV_DATA">Data:</label>
        <input type="text" id="ATV_DATA" name="ATV_DATA">
    </div>
    <div>
        <label for="ATV_DESCRICAO">Descrição:</label>
        <input type="text" id="ATV_DESCRICAO" name="ATV_DESCRICAO" />
    </div>
    <div>
